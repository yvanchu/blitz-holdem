...
import type { LastAction } from '../utils/lastAction';
...
interface GameState {
  ...
  // Most recent action taken by a seat, shown as an on-table indicator.
  // Cleared when a new hand starts or a new street begins.
