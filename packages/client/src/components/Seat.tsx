...
export default function Seat({
  ...
  const BetChip = () =>
    (
      <div
        className={`my-1 flex min-w-[54px] sm:min-w-[66px] items-center justify-center gap-1 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-amber-500 text-black text-xs sm:text-sm font-bold shadow-lg ${
