...
export default function Seat({
  ...
  const BetChip = () =>
    (
      <div
        className={`my-1 flex min-w-[54px] sm:min-w-[66px] items-center justify-center gap-1 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-amber-500 text-black text-xs sm:text-sm font-mono font-bold tabular-nums shadow-lg ${
...
function PlayerInfo({
  ...
  // Amount this player gained this hand. On a split pot both players win their
  // share, so read the per-player amount from splitWinners; otherwise only the
  // single winner shows a gain. (UX §6: "Hand won → +Xs gain shown".)
  const gain =
